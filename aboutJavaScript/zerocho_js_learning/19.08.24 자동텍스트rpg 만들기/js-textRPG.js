...
Hero.prototype.damaged = function(damage) {
  this.hp -= damage;
...
Monster.prototype.constructor = Monster; //Monster생성자가 Character생성자 함수를 상속받고 prototype까지 상속받았음~
